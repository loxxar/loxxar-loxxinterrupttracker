...
if locale == "zhTW" then
    ...
    T["CB_ALERT_CAST"]    = "可打斷施法的警報"
    T["CB_ROTATION"]      = "啟用打斷輪換"
    T["DD_MAX_HISTORY"]   = "歷史紀錄限制: "
    T["DD_MAX_HISTORY_TIP"] = "過去的紀錄保存在磁碟 - 一旦達到限制，舊的紀錄將被刪除"
    T["ALERT_LOCKED"]     = "已鎖定: %s (%.0f秒)"
    T["ALERT_NO_KICK_CAST"] = "!! 沒有打斷 — %s 正施放 !!"
    T["SCORE_TITLE"]      = "歷史打斷得分"
    T["SCORE_RATIO"]      = "比率"
    T["BTN_CLEAR"]        = "清除"
    T["CC_TITLE"]         = "控場追蹤器"
    T["CC_NO_CC"]         = "無控場可用"
    T["CB_SHOW_CC"]       = "顯示控場追蹤器"

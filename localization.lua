--[[
    ...
    Supported locales: enUS, frFR, deDE, itIT, esES, esMX, zhTW, koKR, jaJA, zhCN
...
if locale == "ruRU" then
    local T = LoxxL
    T["TITLE"]            = "Прерывания"
    T["NO_KICK"]          = "Прерывание недоступно"
    T["READY"]            = "ГОТОВ"
    T["TOOLTIP_CD"]       = "Восстановление: %.1fs / %.0fs",
    T["TOOLTIP_READY"]    = "ГОТОВ"
    T["ALERT_ONE_READY"]  = "%s - ГОТОВ"
    T["ALERT_N_READY"]    = "%d прерываний готово  (%s)"
    T["ALERT_INCOMING"]   = "%s через %.1fs"
    T["ALERT_NO_KICK"]    = "БЕЗ ПРЕРЫВАНИЙ - %.0fs"
    T["SETTINGS_TITLE"]   = "Loxx Interrupt Tracker",
    T["SEC_DISPLAY"]      = "ОТОБРАЖЕНИЕ",
    T["SEC_OPTIONS"]      = "НАСТРОЙКИ",
    T["SEC_APPEARANCE"]   = "Внешний вид",
    T["SEC_SHOW_IN"]      = "ПОКАЗАТЬ В",
    T["SEC_SOUND"]        = "ЗВУК",
    T["SEC_UI"]           = "UI",
    ...
    T["SL_CD_SIZE"]       = "Размер восстановления: %d",
    T["SL_READY_SIZE"]    = "Размер готовности: %d",
    T["DD_FONT"]          = "Шрифт: ",
    T["DD_COLOR"]         = "Цвет: ",
    T["DD_BAR_TEXTURE"]   = "Текстура полосы: ",
    T["DD_SOUND"]         = "Звук: ",
    T["CB_SHOW_TITLE"]    = "Показать заголовок",
    T["CB_LOCK_POS"]      = "Положение блокировки",
    T["CB_SHOW_READY"]    = "Показать 'ГОТОВ'",
    T["CB_KICKS_BAR"]     = "Показать индикатор 'X готов прервать каст'.",
    T["CB_HIDE_OOC"]      = "Скрывать, когда не в бою",
    T["CB_TOOLTIP"]       = "Всплывающая подсказка при наведении курсора",
    T["CB_ROTATION"]      = "Включить ротацию",
    T["BTN_CHANGELOG"]    = "Список изменений",
    T["BTN_SAVE_POS"]     = "Сохранить положение",
    T["BTN_RUN_STATS"]    = "Статистика прохождений",
    T["BTN_COMMANDS"]     = "Команды",
    T["BTN_MANAGE_ROT"]   = "Управление ротацией прерываний",
    T["VIS_DUNGEONS"]     = "Подземелья",
    T["VIS_ARENA"]        = "Арена",
    T["VIS_OPEN_WORLD"]   = "Открытый мир",
    T["ROT_MAINTENANCE"]  = "На техническом обслуживании",
    T["ROT_TITLE"]        = "Ротация прерываний",
    T["ROT_RESET"]        = "Сброс",
    T["ROT_SYNC"]         = "Синхронизация группы",
    T["ROT_SYNCED"]       = "Ротация синхронизирована с группой.",
    T["CHANGELOG_TITLE"]  = "Список изменений",
    T["CHANGELOG_EMPTY"]  = "Список изменений отсутствует.",
    T["STATS_TITLE"]      = "Статистика прерываний",
    T["STATS_CLEAR"]      = "Очистить всё",
    T["STATS_ALLTIME"]    = "За всё время · %d %s",
    T["STATS_RUN"]        = "прохождение",
    T["STATS_RUNS"]       = "прохождения",
    T["STATS_CURRENT"]    = "Текущее прохождение",
    T["STATS_HISTORY"]    = "История  (%d)",
    T["STATS_NO_KICKS"]   = "В ходе этого прохождения прерываний пока не зафиксировано.",
    T["STATS_EMPTY"]      = "Статистика пока отсутствует",
    T["STATS_HINT"]       = "Запустите подземелье/арену и прерывайте заклинания, чтобы записать данные.",
    T["STATS_TIP"]        = "Совет: используйте команду /loxx test для быстрой проверки режима дисплея.",
    T["STATS_KICK"]       = "прерывание",
    T["STATS_KICKS"]      = "прерывания",
    T["POS_SAVED"]        = "Положение сохранено!",
    T["POS_NO_FRAME"]     = "Нет доступного фрейма для сохранения.",
    T["POS_HIDDEN"]       = "Фрейм скрыт, сохранить положение невозможно.",
    T["CMD_LOCKED"]       = "Заблокировано",
    T["CMD_UNLOCKED"]     = "Разблокировано",
    T["CMD_TEST_ON"]      = "Тестовый режим |cFF00FF00ВКЛ.|r - 3 фиктивных игрока. /loxx test - остановить.",
    T["CMD_TEST_OFF"]     = "Тестовый режим |cFFFF4444ВЫКЛ.|r",
    T["CMD_HIST_CLEAR"]   = "История прохождений очищена.",
    T["CMD_LOG_CLEAR"]    = "Журнал ошибок очищен.",
    T["CMD_NO_LOGS"]      = "Ошибок не зафиксировано.",
    T["KA_P1_LABEL"]      = "ПРЕРВАТЬ СЕЙЧАС",
    T["KA_P2_LABEL"]      = "ПРЕРВАТЬ",
    T["KA_P3_LABEL"]      = "НЕОБЯЗАТЕЛЬНО",
    T["KA_KICKER"]        = "→ %s",
    T["KA_MOVE_HINT"]     = "Перетащите для изменения положения",
end
